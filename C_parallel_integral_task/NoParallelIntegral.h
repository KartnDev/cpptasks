...
//  first_upper and first_lower : a(lower) and b(upper) borders of first integral (closest to f(x, y) )
                         ...
                         int partition_x, int partition_y)
{
    ...
    for(size_t i = 0; i < partition_x; i++)
    {
...
double r_triple_integral(double (*lambda)(double, double, double),
                        double first_upper, double first_lower, 
                        double second_upper, double second_lower, 
